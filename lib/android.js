...
export function getArtClassSpec (vm) {
  ...
  vm.perform(env => {
    ...
    try {
      ...
      if (getArtApexVersion() < 361104604) {
      ...
      console.log(`[art] java/lang/Thread ifieldOffset=0x${ifieldOffset.toString(16)} sfieldOffset=0x${sfieldOffset.toString(16)} offsetMethods=0x${offsetMethods.toString(16)} offsetCopiedMethods=0x${offsetCopiedMethods.toString(16)}`);
